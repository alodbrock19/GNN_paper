...
def mscmg_adjacency_calculator(window_data_numpy, return_threshold=0.01, max_dist_threshold=5):
    """
    ...
    def process(self) -> None:
        ...
        for idx in range(num_samples):
            ...
            data = Data(
                ...
                y=y_return  # We store continuous return; convert to binary in training loop
            )
